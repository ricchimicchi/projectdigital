    ...
    return (
        <section className='mt-20 1xl:mt-12'>
            <div className='max-w-[1100px] mx-auto px-2'>
                ...
                <div className='grid grid-cols-2 2xl:grid-cols-1 gap-5 3xl:gap-8 mt-32'>
                    <div>
                    ...
                    <div className='mt-1 px-1'>
                        ...
                        <p className='mt-2 font-semibold text-lg 1xl:text-base'>{dataFilter.main_description}</p>
                        <div>
