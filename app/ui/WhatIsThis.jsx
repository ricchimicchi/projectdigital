    ...
    return (
        <div className='mt-44 2xl:mt-7 px-1.5 py-12'>
            <div className='flex items-center justify-center flex-col'>
                ...
                <p className="max-w-[700px] dark:text-white/50 font-medium text-center mt-3 1xl:text-sm leading-[18px]">Our project is specially designed to free you from the complex world of the <span className="dark:text-white text-black/60 tracking-tighter font-extrabold underline">Matrix</span>  in a short time and help you achieve a more liberated, more comfortable life.</p>
